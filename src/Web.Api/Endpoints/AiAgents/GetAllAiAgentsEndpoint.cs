...
[Authorize]
public class GetAllAiAgentsEndpoint : EndpointWithoutRequest
{
    public override void Configure()
    {
        Get("/api/aiagent/GetAllAgentsByCategories");
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        var result = await new GetAllAiAgentsQuery(Guid.Parse(userId)).ExecuteAsync(ct: ct);
        if (result.IsSuccess)
