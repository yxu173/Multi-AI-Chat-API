...
[Authorize]
public class GetMyEnabledAiModelsEndpoint : EndpointWithoutRequest
{
    public override void Configure()
    {
        Get("/api/aimodel/GetUserEnabledAiModel/me");
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        var result = await new GetEnabledAiModelsByUserIdQuery(Guid.Parse(userId)).ExecuteAsync(ct: ct);
        if (result.IsSuccess)
