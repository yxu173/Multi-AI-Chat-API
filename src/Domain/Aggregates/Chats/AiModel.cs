...
public sealed class AiModel
{
    ...
    public static AiModel Create(string name, ModelType modelType, Guid aiProviderId, double inputTokenPricePer1K, double outputTokenPricePer1K, string modelCode, int? maxInputTokens = null, int? maxOutputTokens = null, bool isEnabled = true)
    {
        return new AiModel
        {
            Id = Guid.NewGuid(),
