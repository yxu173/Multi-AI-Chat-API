...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20250515070708_AddLargeFiles")]
    partial class AddLargeFiles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Aggregates.Chats.FileAttachment", b =>
                {
                    ...
                    b.Property<Guid?>("LargeFileUploadId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Aggregates.Files.LargeFileUpload", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("LargeFileUploads");
                });

            modelBuilder.Entity("Domain.Aggregates.Files.UploadPart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("LargeFileUploadId", "PartNumber")
                        .IsUnique();

                    b.ToTable("UploadPart");
                });
            ...
            modelBuilder.Entity("Domain.Aggregates.Files.UploadPart", b =>
                {
                    b.HasOne("Domain.Aggregates.Files.LargeFileUpload", "LargeFileUpload")
                        .WithMany("Parts")
                        .HasForeignKey("LargeFileUploadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LargeFileUpload");
                });
