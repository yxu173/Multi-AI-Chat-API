...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20250706102055_AddNewIndexes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Aggregates.AiAgents.AiAgent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Aggregates.AiAgents.AiAgentPlugin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Aggregates.Chats.Message", b =>
                {
                    ...
                    b.HasIndex("ChatSessionId", "IsFromAi")
            ...
            modelBuilder.Entity("Domain.Aggregates.Chats.SharedChat", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Aggregates.Llms.AiModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Aggregates.Llms.Plugin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Aggregates.Admin.ProviderApiKey", b =>
                {
                    b.HasOne("Domain.Aggregates.Llms.AiProvider", "AiProvider")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Aggregates.AiAgents.AiAgent", b =>
                {
                    b.HasOne("Domain.Aggregates.Llms.AiModel", "AiModel")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Aggregates.AiAgents.AiAgentPlugin", b =>
                {
                    b.HasOne("Domain.Aggregates.AiAgents.AiAgent", "AiAgent")
                        .WithMany("AiAgentPlugins")
                        .HasForeignKey("AiAgentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Aggregates.Llms.Plugin", "Plugin")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Aggregates.Chats.SharedChat", b =>
                {
                    b.HasOne("Domain.Aggregates.Chats.ChatSession", "Chat")
                        .WithMany()
